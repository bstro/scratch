...
if(!((function (){var G__25813 = app_db;
if(G__25813){
...
return G__25813.reagent$ratom$IReactiveAtom$;
}
})())){
return true;
} else {
if((!G__25813.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,reagent.ratom.IReactiveAtom,G__25813);
} else {
return false;
}
}
...
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__25819){
...
return cljs.core.get_in.call(null,new_db,p1__25820_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__25821_SHARP_){
return cljs.core.get_in.call(null,db,p1__25821_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
while (G__25822__i < G__25822__a.length) {G__25822__a[G__25822__i] = arguments[G__25822__i + 2]; ++G__25822__i;}
  in_paths = new cljs.core.IndexedSeq(G__25822__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__25823){
var f = cljs.core.first(arglist__25823);
arglist__25823 = cljs.core.next(arglist__25823);
var out_path = cljs.core.first(arglist__25823);
var in_paths = cljs.core.rest(arglist__25823);
...
//# sourceMappingURL=middleware.js.map?rel=1437351689095