...
}catch (e29536){if((e29536 instanceof Error)){
var e = e29536;
return null;
} else {
throw e29536;
...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__29537){
var map__29539 = p__29537;
...
var opts = map__29539__$1;
var build_id = cljs.core.get.call(null,map__29539__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
var websocket_url = cljs.core.get.call(null,map__29539__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var retried_count = cljs.core.get.call(null,map__29539__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var retry_count = cljs.core.get.call(null,map__29539__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
...
socket.onmessage = ((function (url,socket,WebSocket,temp__4124__auto__,map__29539,map__29539__$1,opts,build_id,websocket_url,retried_count,retry_count){
...
});})(url,socket,WebSocket,temp__4124__auto__,map__29539,map__29539__$1,opts,build_id,websocket_url,retried_count,retry_count))
;

socket.onopen = ((function (url,socket,WebSocket,temp__4124__auto__,map__29539,map__29539__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
...
socket.onclose = ((function (url,socket,WebSocket,temp__4124__auto__,map__29539,map__29539__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__4124__auto__,map__29539,map__29539__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__4124__auto__,map__29539,map__29539__$1,opts,build_id,websocket_url,retried_count,retry_count))
...
socket.onerror = ((function (url,socket,WebSocket,temp__4124__auto__,map__29539,map__29539__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
...
//# sourceMappingURL=socket.js.map?rel=1437351693422