...
var G__25506 = o;
(G__25506[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__25507__delegate = function (args){
...
while (G__25508__i < G__25508__a.length) {G__25508__a[G__25508__i] = arguments[G__25508__i + 0]; ++G__25508__i;}
  args = new cljs.core.IndexedSeq(G__25508__a,0);
} 
return G__25507__delegate.call(this,args);};
G__25507.cljs$lang$maxFixedArity = 0;
G__25507.cljs$lang$applyTo = (function (arglist__25509){
var args = cljs.core.seq(arglist__25509);
return G__25507__delegate(args);
});
...
var old_25510 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_25510))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_25510)].join(''):class$));
} else {
}
...
var G__25513 = jsprops;
(G__25513["defaultValue"] = value);

(G__25513["onChange"] = ((function (G__25513,v,value,on_change){
return (function (p1__25511_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__25511_SHARP_);
});})(G__25513,v,value,on_change))
);
...
var vec__25515 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__25515,(0),null);
var id = cljs.core.nth.call(null,vec__25515,(1),null);
var class$ = cljs.core.nth.call(null,vec__25515,(2),null);
...
var temp__4128__auto__ = (function (){var G__25517 = cljs.core.meta.call(null,v);
var G__25517__$1 = (((G__25517 == null))?null:reagent.impl.template.get_key.call(null,G__25517));
return G__25517__$1;
})();
if((temp__4128__auto__ == null)){
...
var jsprops = {"argv": v};
var G__25519_25520 = v;
var G__25519_25521__$1 = (((G__25519_25520 == null))?null:reagent.impl.template.key_from_vec.call(null,G__25519_25520));
var G__25519_25522__$2 = (((G__25519_25521__$1 == null))?null:(jsprops["key"] = G__25519_25521__$1));
...
var p = (function (){var temp__4128__auto__ = (function (){var G__25525 = cljs.core.meta.call(null,argv);
var G__25525__$1 = (((G__25525 == null))?null:reagent.impl.template.get_key.call(null,G__25525));
return G__25525__$1;
})();
if((temp__4128__auto__ == null)){
return jsprops;
...
var G__25526 = (((jsprops == null))?{}:jsprops);
(G__25526["key"] = key);
...
var n__19006__auto___25527 = a.length;
var i_25528 = (0);
while(true){
if((i_25528 < n__19006__auto___25527)){
(a[i_25528] = reagent.impl.template.as_element.call(null,(a[i_25528])));

var G__25529 = (i_25528 + (1));
i_25528 = G__25529;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__19006__auto___25530 = a.length;
var i_25531 = (0);
while(true){
if((i_25531 < n__19006__auto___25530)){
var val_25532 = (a[i_25531]);
if((cljs.core.vector_QMARK_.call(null,val_25532)) && ((reagent.impl.template.key_from_vec.call(null,val_25532) == null))){
(o["no-key"] = true);
} else {
}

(a[i_25531] = reagent.impl.template.as_element.call(null,val_25532));

var G__25533 = (i_25531 + (1));
i_25531 = G__25533;
continue;
} else {
}
...
var G__25535 = (cljs.core.count.call(null,argv) - first_child);
switch (G__25535) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__25535){
...
//# sourceMappingURL=template.js.map?rel=1437351688036