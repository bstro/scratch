...
if(!((function (){var G__25666 = app_db;
if(G__25666){
...
return G__25666.reagent$ratom$IReactiveAtom$;
}
})())){
return true;
} else {
if((!G__25666.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,reagent.ratom.IReactiveAtom,G__25666);
} else {
return false;
}
}
...
var G__25671__i = 0, G__25671__a = new Array(arguments.length -  0);
while (G__25671__i < G__25671__a.length) {G__25671__a[G__25671__i] = arguments[G__25671__i + 0]; ++G__25671__i;}
  args = new cljs.core.IndexedSeq(G__25671__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__25672){
var args = cljs.core.seq(arglist__25672);
...
return cljs.core.get_in.call(null,new_db,p1__25673_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__25674_SHARP_){
return cljs.core.get_in.call(null,db,p1__25674_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
while (G__25675__i < G__25675__a.length) {G__25675__a[G__25675__i] = arguments[G__25675__i + 2]; ++G__25675__i;}
  in_paths = new cljs.core.IndexedSeq(G__25675__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__25676){
var f = cljs.core.first(arglist__25676);
arglist__25676 = cljs.core.next(arglist__25676);
var out_path = cljs.core.first(arglist__25676);
var in_paths = cljs.core.rest(arglist__25676);
...
//# sourceMappingURL=middleware.js.map?rel=1436140469067